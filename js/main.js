...
function getWeather() {
    fetch("https://api.lisweb.cn/API/ip.php")
        .then(response => response.json())
        .then(data => {
            let str = data.data.city
            let city = str.replace(/市/g, '')
            $('#city_text').html(city);
            fetch("https://api.lisweb.cn/API/weather.php?city=" + data.data.adcode)
                .then(response => response.json())
                .then(location => {
                    $('#wea_text').html(location.data.weather)
                    $('#tem_text').html(location.data.temperature + "°C&nbsp;")
                    $('#win_text').html(location.data.winddirection)
                    $('#win_speed').html(location.data.windpower + "级")
